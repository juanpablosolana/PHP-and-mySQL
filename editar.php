...
<fieldset>
<div class="row"><legend> Modificar artículo :</legend>
<div class="col-md-2"><aside>Nombre</aside> <input id="Nombre" type="text"  name="Nombre" value="<?php echo $row[Nombre];?>"> </div>
<div class="col-md-2"><aside>Codigo</aside> <input id="Codigo" type="text"  name="Codigo" value="<?php echo $row[Codigo];?>" readonly yes > </div>
...
<div class="col-md-2"><aside>Cantidad</aside><input type="text" name="Cantidad" placeholder="Cantidad" value="<?php echo $row[Cantidad];?>"   pattern="[0-9]{1,4}" title="Solo se permiten números enteros" /></div>
<div class="col-md-2"><aside>Descripción</aside>
<textarea rows="4" cols="50"  name="Descripcion" value="<?php echo $row[Descripcion];?>">
